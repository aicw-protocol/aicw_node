module github.com/aicw/aicw_node

go 1.25.8

// AICW-FORK: This is a fork of github.com/fystack/mpcium
// We only modify the eligibility layer (identity verification, peer management)
// TSS core (tss-lib, ecdsa_*.go, eddsa_*.go) remains untouched

require (
	github.com/bnb-chain/tss-lib/v2 v2.0.2
	github.com/fystack/mpcium v0.0.0
...
// Use local path for original mpcium (for development)
replace github.com/fystack/mpcium => ../mpcium

// Required by tss-lib (same as original mpcium)
